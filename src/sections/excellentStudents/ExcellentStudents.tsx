...
const ExcellentStudents: React.FC<ExcellentStudentsProps> = () => {
  return (
    <section className="flex flex-col items-center mt-[60px] relative h-[526px]">
      <h2 className="text-[#2BB4A0] font-medium text-[44px] leading-[1.2] text-center">Học sinh ưu tú</h2>
      <p className="text-2xl font-normal text-[#616364] text-center">
        <span className="text-[#2BB4A0]">80%</span> học sinh đạt{' '}
        <span className="text-[#EC2E2E] text-[28px] font-bold">8+</span>, <span className="text-[#2BB4A0]">65%</span>{' '}
      ...
      <div className="w-full h-[151px] flex justify-center items-center">
        <button className="w-[47px] h-[47px] rounded-full border flex justify-center items-center border-[#2BB4A0] mr-[10px]">
          <ChevronLeftIcon className="w-[21px] text-[#2BB4A0]" />
        </button>
        <button className="w-[47px] h-[47px] rounded-full border flex justify-center items-center border-[#2BB4A0]">
          <ChevronRightIcon className="w-[18px] text-[#2BB4A0]" />
        </button>
      </div>
    </section>
  )
