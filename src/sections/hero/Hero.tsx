    ...
    <section className="hero">
      ...
      <div className="flex absolute w-[248px] h-[69px] border border-[#EBF0F4] rounded-[10px] px-3 py-3 top-[191px] right-[440px] bg-[#ffffff]">
        ...
        <div className="ml-[7px]">
          <div className="font-bold text-sm text-[#004FC5]">Cô Nguyễn Phương Thúy</div>
      ...
      <div className="w-[162px] h-[89px] bg-[#ffffff] border border-[#EBF0F4] rounded-[10px] px-3 py-3 text-center bottom-[79px] right-[133px] absolute">
        <div className="font-bold text-sm text-[#004FC5]">Các chuyên gia</div>
